...
if kol_variantov == 1:
    ...
    if x%2==0:
        ...
        print("слишкомм много или мало вопросов для двух вариантов")
    ...
    if x%3==0:
        ...
        print("слишком много или мало вопросов для трех вариантов")
    ...
    if x%4==0:
        ...
        print("слишком много или мало вопросов для четырех вариантов")
else:
